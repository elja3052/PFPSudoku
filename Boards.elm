...
easyBoard1 =
    [[(-1,True),(-1,True),(-1,True),(2,False),(6,False),(-1,True),(7,False),(-1,True),(1,False)], 
    [(6,False),(8,False),(-1,True),(-1,True),(7,False),(-1,True),(-1,True),(9,False),(-1,True)],
    [(1,False),(9,False),(-1,True),(-1,True),(-1,True),(4,False),(5,False),(-1,True),(-1,True)],
    [(8,False),(2,False),(-1,True),(1,False),(-1,True),(-1,True),(-1,True),(4,False),(-1,True)],
    [(-1,True),(-1,True),(4,False),(6,False),(-1,True),(2,False),(9,False),(-1,True),(-1,True)], 
    [(-1,True),(5,False),(-1,True),(-1,True),(-1,True),(3,False),(-1,True),(2,False),(8,False)],
    [(-1,True),(-1,True),(9,False),(3,False),(-1,True),(-1,True),(-1,True),(7,False),(4,False)], 
    [(-1,True),(4,False),(-1,True),(-1,True),(5,False),(-1,True),(-1,True),(3,False),(6,False)], 
    [(7,False),(-1,True),(3,False),(-1,True),(1,False),(8,False),(-1,True),(-1,True),(-1,True)]]
...
easyBoard1Solved =
    ...
    [(6,False),(8,False),(2,True),(5,True),(7,False),(1,True),(4,True),(9,False),(3,True)],
    [(1,False),(9,False),(7,True),(8,True),(3,True),(4,False),(5,False),(6,True),(2,True)],
    [(8,False),(2,False),(6,True),(1,False),(9,True),(5,True),(3,True),(4,False),(7,True)],
...
easyBoard2 =
    [[(1,False),(-1,True),(-1,True),(4,False),(8,False),(9,False),(-1,True),(-1,True),(6,False)], 
    [(7,False),(3,False),(-1,True),(-1,True),(-1,True),(-1,True),(-1,True),(4,False),(-1,True)],
    [(-1,True),(-1,True),(-1,True),(-1,True),(-1,True),(1,False),(2,False),(9,False),(5,False)],
    [(-1,True),(-1,True),(7,False),(1,False),(2,False),(-1,True),(6,False),(-1,True),(-1,True)],
    [(5,False),(-1,True),(-1,True),(7,False),(-1,True),(3,False),(-1,True),(-1,True),(8,False)], 
    [(-1,True),(-1,True),(6,False),(-1,True),(9,False),(5,False),(7,False),(-1,True),(-1,True)],
    [(9,False),(1,False),(4,False),(6,False),(-1,True),(-1,True),(-1,True),(-1,True),(-1,True)], 
    [(-1,True),(2,False),(-1,True),(-1,True),(-1,True),(-1,True),(-1,True),(3,False),(7,False)], 
    [(8,False),(-1,True),(-1,True),(5,False),(1,False),(2,False),(-1,True),(-1,True),(4,False)]]

{-easyBoard2Solved : List (List (Int, Bool)) --(value,mutable?), if value is -1, will be blank when displayed
easyBoard2Solved =
    [[(1,True),(5,True),(2,True),(4,False),(8,False),(9,True),(3,True),(7,True),(6,False)], 
...
hardBoard1 =
    [[(-1,True),(2,False),(-1,True),(-1,True),(-1,True),(-1,True),(-1,True),(-1,True),(-1,True)], 
    [(-1,True),(-1,True),(-1,True),(6,False),(-1,True),(-1,True),(-1,True),(-1,True),(3,False)],
    [(-1,True),(7,False),(4,False),(-1,True),(8,False),(-1,True),(-1,True),(-1,True),(-1,True)],
    [(-1,True),(-1,True),(-1,True),(-1,True),(-1,True),(3,False),(-1,True),(-1,True),(2,False)],
    [(-1,True),(8,False),(-1,True),(-1,True),(4,False),(-1,True),(-1,True),(1,False),(-1,True)], 
    [(6,False),(-1,True),(-1,True),(5,False),(-1,True),(-1,True),(-1,True),(-1,True),(-1,True)],
    [(-1,True),(-1,True),(-1,True),(-1,True),(1,False),(-1,True),(7,False),(8,False),(-1,True)], 
    [(5,False),(-1,True),(-1,True),(-1,True),(-1,True),(9,False),(-1,True),(-1,True),(-1,True)], 
    [(-1,True),(-1,True),(-1,True),(-1,True),(-1,True),(-1,True),(-1,True),(4,False),(-1,True)]]
